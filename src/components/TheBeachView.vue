...
<template>
  ...
  <a-text  emit-when-near=" event: showTextValue;" align="center" value="Welcome on the Island !" position="0 1.5 7"
  @showTextValue=" showTextIntro()"></a-text>
  <a-text v-if="textIntro"  emit-when-near=" event: showTextValue2;" align="center" value="    YOU CAN" position="0 1.5 0"
...
<!--   <a-box color="red" depth="2" height="3" width="5" position="0 1.6 -14.827" visible="false"
  ...
  <a-entity position="-30 2 -85.6"
    light="type: spot; angle: 60; color:red; intensity:50; target:#scubaLeft; decay:500;"></a-entity>
  <a-entity position="40 2 -60.6"
    light="type: spot; angle: 60; color:red; intensity:50; target:#scubaRight; decay:500;"></a-entity>
  <a-entity position="25 2 -57.6"
    light="type: spot; angle: 60; color:red; intensity:50; target:#telescopee; decay:500;"></a-entity>
  ...
  <TheSpaceship id="vaisseau" position="-53 80 -150" rotation="0 90 0" scale="3 3 3" gltf-model="#skyship"></TheSpaceship>
  <TheAscenceur position="-53 0 -150" scale="3 3 3" gltf-model="#platform"></TheAscenceur>
  <!--   <TheCorde id="corde" position="-53 40 -150" scale="2 8 2" gltf-model="#rope"></TheCorde> -->
  <a-entity position="-53 1 -150" id="plateformEmplacement"></a-entity>
  <a-entity position="-53 6 -150"
